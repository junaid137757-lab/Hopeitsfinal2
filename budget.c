...
{
    /* Deviation (Rule 11.5): qsort's comparator interface requires
       converting from a pointer to void. This is the standard,
       unavoidable idiom for using the C library qsort function. */
